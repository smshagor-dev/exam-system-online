...
import TeacherCourseworkGradingStudio from '@/components/teacher/TeacherCourseworkGradingStudio'
import { requireRole } from '@/lib/auth'
import { getTeacherEnterpriseCourseworkWorkspace } from '@/lib/coursework-enterprise-workspace'
import { UserRole } from '@prisma/client'

export default async function TeacherCourseworkGradingPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <TeacherCourseworkGradingStudio attempts={workspace.attempts} grades={workspace.grades} />
    </div>
  )
}
